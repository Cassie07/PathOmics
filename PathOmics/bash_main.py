...
parser.add_argument('--feature_folder', default='/home/kding1/projects/2023_PathOmics/Upload_to_server/TCGA_COAD/Extracted_feature', help='extracted feature folder path')
...
#    params = parser.parse_args()
    ...
    load_path = '/home/kding1/projects/2023_PathOmics/Upload_to_server/PathOmics/{}/{}/{}_model_{}_OmicBag_{}_FusionType_{}_OmicType_{}'.format(params.save_model_folder_name, params.experiment_folder_name, params.results_string, params.model_type, params.omic_bag_type, params.model_pretrain_fusion_type, params.omic_modal)
    ...
    #         test_loader = params.seperate_test_loader
        ...
        if params.seperate_test:
            logs, best_test_c_index, best_epoch = train_and_evaluate(fold, params.finetune_epochs, best_pretrain_model, [train_loader, test_loader, seperate_test_loader], finetune_optimizer, loss_fn, reg_fn, device, save_path, lambda_reg=0., gc = params.gradient_accumulation_steps, save_model = False, seperate_test_mode = params.seperate_test, model_mode = 'Finetune', fold_mode = 'k_fold')
        else:
            logs, best_test_c_index, best_epoch = train_and_evaluate(fold, params.finetune_epochs, best_pretrain_model, [train_loader, test_loader], finetune_optimizer, loss_fn, reg_fn, device, save_path, lambda_reg=0., gc = params.gradient_accumulation_steps, save_model = False, seperate_test_mode = params.seperate_test, model_mode = 'Finetune', fold_mode = 'k_fold')
